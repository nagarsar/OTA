...
defined('FM_ROOT_PATH') || define('FM_ROOT_PATH', $root_path . '/sources');
...
if ($use_auth) {
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        ...
        <div class="path login-form">
                <img src="http://nathanhue.me/style/images/logo.png" alt="Wireless Compiler File manager" style="margin:20px;">
